%global git 2e7748263961a74622eba47f43fdce3187554443
...
# bin
for i in add-user suggest-ip status generate-dns-zones
do
...
# libexec
for i in generate-secrets housekeeping init daemon-sync
do
